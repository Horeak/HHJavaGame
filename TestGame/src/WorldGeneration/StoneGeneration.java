	...
	public void generate() {
		...
		for(int x = 0; x < MainFile.currentWorld.worldSize.xSize; x++) {
			...
			for (int y = MainFile.currentWorld.worldSize.ySize - 1; y > 0; y--) {
				...
				try {
					if (       MainFile.currentWorld.getBlock(x, y - 1) != null
							&& MainFile.currentWorld.getBlock(x, y - 2) != null
							&& MainFile.currentWorld.getBlock(x, y - 3) != null
							&& MainFile.currentWorld.getBlock(x, y - 4) != null
							&& MainFile.currentWorld.getBlock(x, y - 5) != null) {
